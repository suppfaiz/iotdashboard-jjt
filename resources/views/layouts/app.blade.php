        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('changelog') }}" class="md:hidden p-2.5 text-slate-500 hover:text-slate-800 focus:outline-none transition-all duration-300 rounded-xl hover:bg-slate-100" title="Changelog">
